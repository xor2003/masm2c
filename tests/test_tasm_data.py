...
class ParserDataTest(unittest.TestCase):
    ...
    def test_data_10040(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_a1024\t\tdb '1024',0")), ('"1024", // _a1024\n', 'char _a1024[5];\n', 5))
    ...
    def test_data_10090(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_a256		db '256',0              ; DATA XREF: _text_init2+1CEo")), ('"256", // _a256\n', 'char _a256[4];\n', 4))

    def test_data_10100(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_a512		db '512',0")), ('"512", // _a512\n', 'char _a512[4];\n', 4))

    def test_data_10110(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_a768		db '768',0")), ('"768", // _a768\n', 'char _a768[4];\n', 4))

    def test_data_10120(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aAdlibSoundcard	db 'Adlib SoundCard',0  ; DATA XREF: dseg:02BAo")), ('"Adlib SoundCard", // _aadlibsoundcard\n', 'char _aadlibsoundcard[16];\n', 16))

    def test_data_10130(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aAdlibSoundcard_0 db 'Adlib SoundCard',0 ; DATA XREF: seg003:0D6Ao")), ('"Adlib SoundCard", // _aadlibsoundcard_0\n', 'char _aadlibsoundcard_0[16];\n', 16))

    def test_data_10140(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aAnd		db ' and '")), ("{' ','a','n','d',' '}, // _aand\n", 'char _aand[5];\n', 5))

    def test_data_10150(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aAndWriteFollowingTe db	' and write following text in your message:'")), ("{' ','a','n','d',' ','w','r','i','t','e',' ','f','o','l','l','o','w','i','n','g',' ','t','e','x','t',' ','i','n',' ','y','o','u','r',' ','m','e','s','s','a','g','e',':'}, // _aandwritefollowingte\n", 'char _aandwritefollowingte[42];\n', 42))

    def test_data_10160(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aArpeggio	db 'Arpeggio       ',0  ; DATA XREF: seg001:loc_1AB0Do")), ('"Arpeggio       ", // _aarpeggio\n', 'char _aarpeggio[16];\n', 16))

    def test_data_10170(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aAt		db ' at',0              ; DATA XREF: seg003:10BFo seg003:1152o ...")), ('" at", // _aat\n', 'char _aat[4];\n', 4))

    def test_data_10180(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aAutoToneporta	db 'Auto TonePorta ',0")), ('"Auto TonePorta ", // _aautotoneporta\n', 'char _aautotoneporta[16];\n', 16))

    def test_data_10190(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aBackspace	db 'BackSpace'")), ("{'B','a','c','k','S','p','a','c','e'}, // _abackspace\n", 'char _abackspace[9];\n', 9))
    ...
    def test_data_10230(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aCh		db 'CH'")), ("{'C','H'}, // _ach\n", 'char _ach[2];\n', 2))
    ...
    def test_data_10250(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aChn		db 'CHN'")), ("{'C','H','N'}, // _achn\n", 'char _achn[3];\n', 3))
    ...
    def test_data_10280(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aCouldNotFindT_0 db 'Could not find the Gravis UltraSound at the specified port addres'")), ("{'C','o','u','l','d',' ','n','o','t',' ','f','i','n','d',' ','t','h','e',' ','G','r','a','v','i','s',' ','U','l','t','r','a','S','o','u','n','d',' ','a','t',' ','t','h','e',' ','s','p','e','c','i','f','i','e','d',' ','p','o','r','t',' ','a','d','d','r','e','s'}, // _acouldnotfindt_0\n", 'char _acouldnotfindt_0[65];\n', 65))
    ...
    def test_data_10300(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aCovox		db 'Covox',0            ; DATA XREF: dseg:02B6o")), ('"Covox", // _acovox\n', 'char _acovox[6];\n', 6))

    def test_data_10310(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aCovox_0	db 'Covox',0            ; DATA XREF: seg003:0D66o")), ('"Covox", // _acovox_0\n', 'char _acovox_0[6];\n', 6))
    ...
    def test_data_10330(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aCtrlDel	db 'Ctrl Del'")), ("{'C','t','r','l',' ','D','e','l'}, // _actrldel\n", 'char _actrldel[8];\n', 8))
    ...
    def test_data_10350(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aCurrentTrack	db 'Current Track :'")), ("{'C','u','r','r','e','n','t',' ','T','r','a','c','k',' ',':'}, // _acurrenttrack\n", 'char _acurrenttrack[15];\n', 15))
    ...
    def test_data_10380(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aCursor_1	db 'Cursor '")), ("{'C','u','r','s','o','r',' '}, // _acursor_1\n", 'char _acursor_1[7];\n', 7))
    ...
    def test_data_10400(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aDecIncAmplify_0 db '  Dec/Inc amplify'")), ("{' ',' ','D','e','c','/','I','n','c',' ','a','m','p','l','i','f','y'}, // _adecincamplify_0\n", 'char _adecincamplify_0[17];\n', 17))

    def test_data_10410(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aDecIncVolume	db 7Eh")), ('126, // _adecincvolume\n', 'db _adecincvolume;\n', 1))
    ...
    def test_data_10450(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aDeleteMarkedFil db 'Delete marked files? [Y/N]',0 ; DATA XREF: _start+635o")), ('"Delete marked files? [Y/N]", // _adeletemarkedfil\n', 'char _adeletemarkedfil[27];\n', 27))
    ...
    def test_data_10470(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aDeviceNotIniti	db 'Device not initialised!',0 ; DATA XREF: sub_12D05+8o")), ('"Device not initialised!", // _adevicenotiniti\n', 'char _adevicenotiniti[24];\n', 24))

    def test_data_10480(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aDisableBpmOnOf	db 7Eh")), ('126, // _adisablebpmonof\n', 'db _adisablebpmonof;\n', 1))
    ...
    def test_data_10500(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aDma		db ', DMA '")), ("{',',' ','D','M','A',' '}, // _adma\n", 'char _adma[6];\n', 6))

    def test_data_10510(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aDosShellTypeEx	db 7Eh")), ('126, // _adosshelltypeex\n', 'db _adosshelltypeex;\n', 1))
    ...
    def test_data_10570(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aEnd		db 'End'")), ("{'E','n','d'}, // _aend\n", 'char _aend[3];\n', 3))

    def test_data_10580(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aEndPattern	db '  End pattern'")), ("{' ',' ','E','n','d',' ','p','a','t','t','e','r','n'}, // _aendpattern\n", 'char _aendpattern[13];\n', 13))

    def test_data_10590(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aEnd_0		db 'End'")), ("{'E','n','d'}, // _aend_0\n", 'char _aend_0[3];\n', 3))

    def test_data_10600(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aEnter		db 'Enter'")), ("{'E','n','t','e','r'}, // _aenter\n", 'char _aenter[5];\n', 5))

    def test_data_10610(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aErrorCouldNotFi db 'Error: Could not find IRQ/DMA!',0Dh,0Ah,0")), ('"Error: Could not find IRQ/DMA!\\r\\n", // _aerrorcouldnotfi\n', 'char _aerrorcouldnotfi[33];\n', 33))

    def test_data_10620(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aErrorCouldNot_0 db 'Error: Could not find IRQ!',0Dh,0Ah,0 ; DATA XREF: _sb_detect_irq+4Co")), ('"Error: Could not find IRQ!\\r\\n", // _aerrorcouldnot_0\n', 'char _aerrorcouldnot_0[29];\n', 29))

    def test_data_10630(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aErrorCouldNot_1 db 'Error: Could not find DMA!',0Dh,0Ah,0 ; DATA XREF: _sb_detect_irq+D6o")), ('"Error: Could not find DMA!\\r\\n", // _aerrorcouldnot_1\n', 'char _aerrorcouldnot_1[29];\n', 29))
    ...
    def test_data_10650(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aEsc		db 'ESC'")), ("{'E','S','C'}, // _aesc\n", 'char _aesc[3];\n', 3))

    def test_data_10660(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aExit		db 'EXIT'")), ("{'E','X','I','T'}, // _aexit\n", 'char _aexit[4];\n', 4))
    ...
    def test_data_10680(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aF10		db 7Fh")), ('127, // _af10\n', 'db _af10;\n', 1))
    ...
    def test_data_10710(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aF11		db 7Fh")), ('127, // _af11\n', 'db _af11;\n', 1))
    ...
    def test_data_10850(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aF9_1		db 7Fh")), ('127, // _af9_1\n', 'db _af9_1;\n', 1))
    ...
    def test_data_10900(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFarFineTempo	db 'FAR Fine Tempo ',0")), ('"FAR Fine Tempo ", // _afarfinetempo\n', 'char _afarfinetempo[16];\n', 16))

    def test_data_10910(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFarTempo	db 'FAR Tempo      ',0")), ('"FAR Tempo      ", // _afartempo\n', 'char _afartempo[16];\n', 16))
    ...
    def test_data_10940(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFastfourierFrequenc db	'  FastFourier Frequency Analysis'")), ("{' ',' ','F','a','s','t','F','o','u','r','i','e','r',' ','F','r','e','q','u','e','n','c','y',' ','A','n','a','l','y','s','i','s'}, // _afastfourierfrequenc\n", 'char _afastfourierfrequenc[32];\n', 32))
    ...
    def test_data_10970(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFileSelectorHelp db 'File Selector Help'")), ("{'F','i','l','e',' ','S','e','l','e','c','t','o','r',' ','H','e','l','p'}, // _afileselectorhelp\n", 'char _afileselectorhelp[18];\n', 18))
    ...
    def test_data_11000(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFinePanning	db 'Fine Panning   ',0")), ('"Fine Panning   ", // _afinepanning\n', 'char _afinepanning[16];\n', 16))
    ...
    def test_data_11020(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFinePortaDown	db 'Fine Porta Down',0")), ('"Fine Porta Down", // _afineportadown\n', 'char _afineportadown[16];\n', 16))

    def test_data_11030(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFinePortaUp	db 'Fine Porta Up  ',0")), ('"Fine Porta Up  ", // _afineportaup\n', 'char _afineportaup[16];\n', 16))

    def test_data_11040(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFineTonePorta	db 'Fine Tone Porta',0")), ('"Fine Tone Porta", // _afinetoneporta\n', 'char _afinetoneporta[16];\n', 16))
    ...
    def test_data_11060(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFineVibrato	db 'Fine Vibrato   ',0")), ('"Fine Vibrato   ", // _afinevibrato\n', 'char _afinevibrato[16];\n', 16))

    def test_data_11070(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFineVolSlide	db 'Fine Vol Slide ',0")), ('"Fine Vol Slide ", // _afinevolslide\n', 'char _afinevolslide[16];\n', 16))

    def test_data_11080(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFineslideDown	db 'FineSlide Down ',0")), ('"FineSlide Down ", // _afineslidedown\n', 'char _afineslidedown[16];\n', 16))

    def test_data_11090(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFineslideUp	db 'FineSlide Up   ',0")), ('"FineSlide Up   ", // _afineslideup\n', 'char _afineslideup[16];\n', 16))

    def test_data_11100(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFinevolumeDown	db 'FineVolume Down',0")), ('"FineVolume Down", // _afinevolumedown\n', 'char _afinevolumedown[16];\n', 16))

    def test_data_11110(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFinevolumeUp	db 'FineVolume Up  ',0")), ('"FineVolume Up  ", // _afinevolumeup\n', 'char _afinevolumeup[16];\n', 16))

    def test_data_11120(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFlt4		db 'FLT4'")), ("{'F','L','T','4'}, // _aflt4\n", 'char _aflt4[4];\n', 4))

    def test_data_11130(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aFlt8		db 'FLT8'")), ("{'F','L','T','8'}, // _aflt8\n", 'char _aflt8[4];\n', 4))
    ...
    def test_data_11160(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aGlissandoCtrl	db 'Glissando Ctrl ',0")), ('"Glissando Ctrl ", // _aglissandoctrl\n', 'char _aglissandoctrl[16];\n', 16))

    def test_data_11170(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aGraphicalScopesOneF db	'  Graphical scopes, one for each channel'")), ("{' ',' ','G','r','a','p','h','i','c','a','l',' ','s','c','o','p','e','s',',',' ','o','n','e',' ','f','o','r',' ','e','a','c','h',' ','c','h','a','n','n','e','l'}, // _agraphicalscopesonef\n", 'char _agraphicalscopesonef[40];\n', 40))

    def test_data_11180(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aGravisMaxCodec	db 'Gravis MAX Codec',0")), ('"Gravis MAX Codec", // _agravismaxcodec\n', 'char _agravismaxcodec[17];\n', 17))
    ...
    def test_data_11210(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aGray		db 7Fh")), ('127, // _agray\n', 'db _agray;\n', 1))
    ...
    def test_data_11230(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aGsft		db 'GSFT'")), ("{'G','S','F','T'}, // _agsft\n", 'char _agsft[4];\n', 4))
    ...
    def test_data_11260(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aHIrq		db 'h, IRQ '")), ("{'h',',',' ','I','R','Q',' '}, // _ahirq\n", 'char _ahirq[7];\n', 7))
    ...
    def test_data_11280(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aHome		db 'Home'")), ("{'H','o','m','e'}, // _ahome\n", 'char _ahome[4];\n', 4))

    def test_data_11290(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aHopeYouLikedUsingTh db	'Hope you liked using the '")), ("{'H','o','p','e',' ','y','o','u',' ','l','i','k','e','d',' ','u','s','i','n','g',' ','t','h','e',' '}, // _ahopeyoulikedusingth\n", 'char _ahopeyoulikedusingth[25];\n', 25))

    def test_data_11300(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aIf		db 'if'")), ("{'i','f'}, // _aif\n", 'char _aif[2];\n', 2))
    ...
    def test_data_11320(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aIgnoreBpmChanges db ' Ignore BPM changes'")), ("{' ','I','g','n','o','r','e',' ','B','P','M',' ','c','h','a','n','g','e','s'}, // _aignorebpmchanges\n", 'char _aignorebpmchanges[19];\n', 19))

    def test_data_11330(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aInertiaMailinglists db	'Inertia Mailinglists'")), ("{'I','n','e','r','t','i','a',' ','M','a','i','l','i','n','g','l','i','s','t','s'}, // _ainertiamailinglists\n", 'char _ainertiamailinglists[20];\n', 20))
    ...
    def test_data_11370(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aInertiaPlayer	db 'Inertia Player'")), ("{'I','n','e','r','t','i','a',' ','P','l','a','y','e','r'}, // _ainertiaplayer\n", 'char _ainertiaplayer[14];\n', 14))
    ...
    def test_data_11400(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aInertiaPlayer_0 db 'Inertia Player',0")), ('"Inertia Player", // _ainertiaplayer_0\n', 'char _ainertiaplayer_0[15];\n', 15))
    ...
    def test_data_11430(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aInvertLoop	db 'Invert Loop    ',0")), ('"Invert Loop    ", // _ainvertloop\n', 'char _ainvertloop[16];\n', 16))
    ...
    def test_data_11450(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aJn		db 'JN'")), ("{'J','N'}, // _ajn\n", 'char _ajn[2];\n', 2))

    def test_data_11460(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aJumpToLoop	db 'Jump To Loop   ',0")), ('"Jump To Loop   ", // _ajumptoloop\n', 'char _ajumptoloop[16];\n', 16))
    ...
    def test_data_11520(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aLoopModule	db 7Eh")), ('126, // _aloopmodule\n', 'db _aloopmodule;\n', 1))

    def test_data_11530(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aLoopModuleWhenDone db ' Loop Module when done'")), ("{' ','L','o','o','p',' ','M','o','d','u','l','e',' ','w','h','e','n',' ','d','o','n','e'}, // _aloopmodulewhendone\n", 'char _aloopmodulewhendone[22];\n', 22))

    def test_data_11540(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aLoopModule_0	db ' Loop module'")), ("{' ','L','o','o','p',' ','m','o','d','u','l','e'}, // _aloopmodule_0\n", 'char _aloopmodule_0[12];\n', 12))

    def test_data_11550(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aLoopPattern	db '  Loop pattern'")), ("{' ',' ','L','o','o','p',' ','p','a','t','t','e','r','n'}, // _alooppattern\n", 'char _alooppattern[14];\n', 14))
    ...
    def test_data_11600(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aMarkFileToDelete db 'Mark file to delete'")), ("{'M','a','r','k',' ','f','i','l','e',' ','t','o',' ','d','e','l','e','t','e'}, // _amarkfiletodelete\n", 'char _amarkfiletodelete[19];\n', 19))
    ...
    def test_data_11620(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aMas_utrack_v	db 'MAS_UTrack_V'")), ("{'M','A','S','_','U','T','r','a','c','k','_','V'}, // _amas_utrack_v\n", 'char _amas_utrack_v[12];\n', 12))
    ...
    def test_data_11680(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aMtm		db 'MTM'")), ("{'M','T','M'}, // _amtm\n", 'char _amtm[3];\n', 3))
    ...
    def test_data_11700(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aMuteChannel	db '  Mute channel'")), ("{' ',' ','M','u','t','e',' ','c','h','a','n','n','e','l'}, // _amutechannel\n", 'char _amutechannel[14];\n', 14))
    ...
    def test_data_11720(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aNotEnoughDramOn db 'Not enough DRAM on UltraSound',0Dh,0Ah,0")), ('"Not enough DRAM on UltraSound\\r\\n", // _anotenoughdramon\n', 'char _anotenoughdramon[32];\n', 32))
    ...
    def test_data_11760(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aNotEnoughMemory db 'Not enough Memory available',0Dh,0Ah,0")), ('"Not enough Memory available\\r\\n", // _anotenoughmemory\n', 'char _anotenoughmemory[30];\n', 30))

    def test_data_11770(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aNoteCut	db 'Note Cut       ',0")), ('"Note Cut       ", // _anotecut\n', 'char _anotecut[16];\n', 16))

    def test_data_11780(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aNoteDelay	db 'Note Delay     ',0")), ('"Note Delay     ", // _anotedelay\n', 'char _anotedelay[16];\n', 16))
    ...
    def test_data_11800(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aOcta		db 'OCTA'")), ("{'O','C','T','A'}, // _aocta\n", 'char _aocta[4];\n', 4))
    ...
    def test_data_11820(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPatternBreak	db 'Pattern Break  ',0")), ('"Pattern Break  ", // _apatternbreak\n', 'char _apatternbreak[16];\n', 16))

    def test_data_11830(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPatternDelay	db 'Pattern Delay  ',0")), ('"Pattern Delay  ", // _apatterndelay\n', 'char _apatterndelay[16];\n', 16))

    def test_data_11840(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPause		db 'Pause'")), ("{'P','a','u','s','e'}, // _apause\n", 'char _apause[5];\n', 5))
    ...
    def test_data_11870(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPgdn		db 'PgDn'")), ("{'P','g','D','n'}, // _apgdn\n", 'char _apgdn[4];\n', 4))

    def test_data_11880(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPgup		db 'PgUp'")), ("{'P','g','U','p'}, // _apgup\n", 'char _apgup[4];\n', 4))
    ...
    def test_data_11930(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPortamentoDown	db 'Portamento Down',0")), ('"Portamento Down", // _aportamentodown\n', 'char _aportamentodown[16];\n', 16))

    def test_data_11940(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPortamentoUp	db 'Portamento Up  ',0")), ('"Portamento Up  ", // _aportamentoup\n', 'char _aportamentoup[16];\n', 16))

    def test_data_11950(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPositionJump	db 'Position Jump  ',0")), ('"Position Jump  ", // _apositionjump\n', 'char _apositionjump[16];\n', 16))

    def test_data_11960(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPress		db 'Press '")), ("{'P','r','e','s','s',' '}, // _apress\n", 'char _apress[6];\n', 6))

    def test_data_11970(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aPressAnyKeyToReturn db	'Press any key to return to the fileselector',0")), ('"Press any key to return to the fileselector", // _apressanykeytoreturn\n', 'char _apressanykeytoreturn[44];\n', 44))
    ...
    def test_data_12010(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aProtracker1_0C	db 7Eh")), ('126, // _aprotracker1_0c\n', 'db _aprotracker1_0c;\n', 1))
    ...
    def test_data_12050(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aQuitIplay	db 'Quit IPLAY'")), ("{'Q','u','i','t',' ','I','P','L','A','Y'}, // _aquitiplay\n", 'char _aquitiplay[10];\n', 10))

    def test_data_12060(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aRealtimeVuMeters db '  Realtime VU meters'")), ("{' ',' ','R','e','a','l','t','i','m','e',' ','V','U',' ','m','e','t','e','r','s'}, // _arealtimevumeters\n", 'char _arealtimevumeters[20];\n', 20))
    ...
    def test_data_12080(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aRetriggerNote	db 'Retrigger Note ',0")), ('"Retrigger Note ", // _aretriggernote\n', 'char _aretriggernote[16];\n', 16))
    ...
    def test_data_12130(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aScrm		db 'SCRM'")), ("{'S','C','R','M'}, // _ascrm\n", 'char _ascrm[4];\n', 4))

    def test_data_12140(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aScrolllock	db 'ScrollLock'")), ("{'S','c','r','o','l','l','L','o','c','k'}, // _ascrolllock\n", 'char _ascrolllock[10];\n', 10))
    ...
    def test_data_12160(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSendEmailTo	db 'Send email to '")), ("{'S','e','n','d',' ','e','m','a','i','l',' ','t','o',' '}, // _asendemailto\n", 'char _asendemailto[14];\n', 14))

    def test_data_12170(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSetAmplify	db 'Set Amplify    ',0")), ('"Set Amplify    ", // _asetamplify\n', 'char _asetamplify[16];\n', 16))
    ...
    def test_data_12190(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSetFinetune	db 'Set FineTune   ',0")), ('"Set FineTune   ", // _asetfinetune\n', 'char _asetfinetune[16];\n', 16))
    ...
    def test_data_12210(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSetPanning	db 'Set Panning    ',0")), ('"Set Panning    ", // _asetpanning\n', 'char _asetpanning[16];\n', 16))

    def test_data_12220(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSetSampleOfs	db 'Set Sample Ofs ',0")), ('"Set Sample Ofs ", // _asetsampleofs\n', 'char _asetsampleofs[16];\n', 16))

    def test_data_12230(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSetSpeed	db 'Set Speed      ',0")), ('"Set Speed      ", // _asetspeed\n', 'char _asetspeed[16];\n', 16))

    def test_data_12240(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSetSpeedBpm	db 'Set Speed/BPM  ',0")), ('"Set Speed/BPM  ", // _asetspeedbpm\n', 'char _asetspeedbpm[16];\n', 16))

    def test_data_12250(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSetStmSpeed	db 'Set STM Speed  ',0")), ('"Set STM Speed  ", // _asetstmspeed\n', 'char _asetstmspeed[16];\n', 16))
    ...
    def test_data_12370(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aSpeed		db 'Speed'")), ("{'S','p','e','e','d'}, // _aspeed\n", 'char _aspeed[5];\n', 5))
    ...
    def test_data_12420(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTab		db 'Tab'")), ("{'T','a','b'}, // _atab\n", 'char _atab[3];\n', 3))

    def test_data_12430(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTab_0		db 'Tab'")), ("{'T','a','b'}, // _atab_0\n", 'char _atab_0[3];\n', 3))

    def test_data_12440(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTdz		db 'TDZ'")), ("{'T','D','Z'}, // _atdz\n", 'char _atdz[3];\n', 3))

    def test_data_12450(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aThe		db 'the '")), ("{'t','h','e',' '}, // _athe\n", 'char _athe[4];\n', 4))
    ...
    def test_data_12500(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aToMoveTheHighlighte db	' to move the highlighted bar'")), ("{' ','t','o',' ','m','o','v','e',' ','t','h','e',' ','h','i','g','h','l','i','g','h','t','e','d',' ','b','a','r'}, // _atomovethehighlighte\n", 'char _atomovethehighlighte[28];\n', 28))

    def test_data_12510(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aToPlayTheModuleOrSe db	' to play the module or select the drive/directory'")), ("{' ','t','o',' ','p','l','a','y',' ','t','h','e',' ','m','o','d','u','l','e',' ','o','r',' ','s','e','l','e','c','t',' ','t','h','e',' ','d','r','i','v','e','/','d','i','r','e','c','t','o','r','y'}, // _atoplaythemoduleorse\n", 'char _atoplaythemoduleorse[49];\n', 49))

    def test_data_12520(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aToReturnTo	db ' to return to '")), ("{' ','t','o',' ','r','e','t','u','r','n',' ','t','o',' '}, // _atoreturnto\n", 'char _atoreturnto[14];\n', 14))

    def test_data_12530(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aToSubscribeToOneOrB db	' to subscribe to one or both of'")), ("{' ','t','o',' ','s','u','b','s','c','r','i','b','e',' ','t','o',' ','o','n','e',' ','o','r',' ','b','o','t','h',' ','o','f'}, // _atosubscribetooneorb\n", 'char _atosubscribetooneorb[31];\n', 31))
    ...
    def test_data_12550(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aToggle24bitInterpol db	' Toggle 24bit Interpolation'")), ("{' ','T','o','g','g','l','e',' ','2','4','b','i','t',' ','I','n','t','e','r','p','o','l','a','t','i','o','n'}, // _atoggle24bitinterpol\n", 'char _atoggle24bitinterpol[27];\n', 27))

    def test_data_12560(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTogglePalNtsc	db '  Toggle PAL/NTSC',0")), ('"  Toggle PAL/NTSC", // _atogglepalntsc\n', 'char _atogglepalntsc[18];\n', 18))

    def test_data_12570(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aToggleQuickreadingO db	'Toggle QuickReading of module name'")), ("{'T','o','g','g','l','e',' ','Q','u','i','c','k','R','e','a','d','i','n','g',' ','o','f',' ','m','o','d','u','l','e',' ','n','a','m','e'}, // _atogglequickreadingo\n", 'char _atogglequickreadingo[34];\n', 34))

    def test_data_12580(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTonePortamento	db 'Tone Portamento',0")), ('"Tone Portamento", // _atoneportamento\n', 'char _atoneportamento[16];\n', 16))
    ...
    def test_data_12600(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTremolo	db 'Tremolo        ',0")), ('"Tremolo        ", // _atremolo\n', 'char _atremolo[16];\n', 16))

    def test_data_12610(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTremoloControl	db 'Tremolo Control',0")), ('"Tremolo Control", // _atremolocontrol\n', 'char _atremolocontrol[16];\n', 16))

    def test_data_12620(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTremor		db 'Tremor         ',0")), ('"Tremor         ", // _atremor\n', 'char _atremor[16];\n', 16))

    def test_data_12630(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aTriller	db 'Triller        ',0")), ('"Triller        ", // _atriller\n', 'char _atriller[16];\n', 16))

    def test_data_12640(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aType		db 'Type '")), ("{'T','y','p','e',' '}, // _atype\n", 'char _atype[5];\n', 5))
    ...
    def test_data_12660(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aUse		db 'Use '")), ("{'U','s','e',' '}, // _ause\n", 'char _ause[4];\n', 4))
    ...
    def test_data_12680(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aVibrato	db 'Vibrato        ',0")), ('"Vibrato        ", // _avibrato\n', 'char _avibrato[16];\n', 16))

    def test_data_12690(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aVibratoControl	db 'Vibrato Control',0")), ('"Vibrato Control", // _avibratocontrol\n', 'char _avibratocontrol[16];\n', 16))
    ...
    def test_data_12720(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aVolumeChange	db 'Volume Change  ',0")), ('"Volume Change  ", // _avolumechange\n', 'char _avolumechange[16];\n', 16))

    def test_data_12730(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aVolumeSliding	db 'Volume Sliding ',0")), ('"Volume Sliding ", // _avolumesliding\n', 'char _avolumesliding[16];\n', 16))

    def test_data_12740(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_aWhichIsWrittenIn db ' which is written in '")), ("{' ','w','h','i','c','h',' ','i','s',' ','w','r','i','t','t','e','n',' ','i','n',' '}, // _awhichiswrittenin\n", 'char _awhichiswrittenin[21];\n', 21))
    ...
    def test_data_12850(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_base_port2	dw 0			; DATA XREF: _wss_init:loc_147C3w")), ('0, // _base_port2\n', 'dw _base_port2;\n', 2))
    ...
    def test_data_12900(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_buffer_1seg	dw 0			; DATA XREF: _text_init2+18Bw")), ('0, // _buffer_1seg\n', 'dw _buffer_1seg;\n', 2))

    def test_data_12910(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_buffer_2seg	dw 0			; DATA XREF: seg001:loc_1A913w")), ('0, // _buffer_2seg\n', 'dw _buffer_2seg;\n', 2))
    ...
    def test_data_12940(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_14F70	db 0			; DATA XREF: _configure_timer+12w")), ('0, // _byte_14f70\n', 'db _byte_14f70;\n', 1))

    def test_data_12950(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_14F71	db 0			; DATA XREF: sub_12D35:loc_12D41w")), ('0, // _byte_14f71\n', 'db _byte_14f71;\n', 1))

    def test_data_12960(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_14F72	db 0			; DATA XREF: sub_13CF6+Dw _text:4F51r")), ('0, // _byte_14f72\n', 'db _byte_14f72;\n', 1))

    def test_data_12970(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_14F73	db 0			; DATA XREF: sub_13CF6+11w")), ('0, // _byte_14f73\n', 'db _byte_14f73;\n', 1))

    def test_data_12980(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_1C1B8	db 0			; DATA XREF: _int9_keybr _dosexec+58w ...")), ('0, // _byte_1c1b8\n', 'db _byte_1c1b8;\n', 1))
    ...
    def test_data_13040(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_1DCF8	db 14h			; DATA XREF: _start+DAr	_callsubx+20r ...")), ('20, // _byte_1dcf8\n', 'db _byte_1dcf8;\n', 1))

    def test_data_13050(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_1DCFB	db 4Bh			; DATA XREF: _callsubx+13r")), ('75, // _byte_1dcfb\n', 'db _byte_1dcfb;\n', 1))

    def test_data_13060(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_1DE70	db 0			; DATA XREF: _start+168w _start+268w ...")), ('0, // _byte_1de70\n', 'db _byte_1de70;\n', 1))

    def test_data_13070(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_24629	db 20h			; DATA XREF: _someplaymode+64r")), ('32, // _byte_24629\n', 'db _byte_24629;\n', 1))

    def test_data_13080(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_257DA	db 10h			; DATA XREF: _useless_writeinr+3Fw")), ('16, // _byte_257da\n', 'db _byte_257da;\n', 1))
    ...
    def test_data_13110(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_30577	db ?			; DATA XREF: _e669_module+32r")), ('0, // _byte_30577\n', 'db _byte_30577;\n', 1))
    ...
    def test_data_13130(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_byte_30639	db ?			; DATA XREF: _ult_module+169r")), ('0, // _byte_30639\n', 'db _byte_30639;\n', 1))
    ...
    def test_data_13150(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_cfg_buffer	db    4			; DATA XREF: _loadcfg+Co _loadcfg+1Er")), ('4, // _cfg_buffer\n', 'db _cfg_buffer;\n', 1))
    ...
    def test_data_13170(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_config_word	dw 0			; DATA XREF: _ems_init+8r")), ('0, // _config_word\n', 'dw _config_word;\n', 2))
    ...
    def test_data_13190(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_covox_txt	db    2			; DATA XREF: seg003:0D7Co seg003:0D7Eo")), ('2, // _covox_txt\n', 'db _covox_txt;\n', 1))

    def test_data_13200(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_critsectpoint_off dw 0			; DATA XREF: _start+150w")), ('0, // _critsectpoint_off\n', 'dw _critsectpoint_off;\n', 2))

    def test_data_13210(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_critsectpoint_seg dw 0			; DATA XREF: _start+154w")), ('0, // _critsectpoint_seg\n', 'dw _critsectpoint_seg;\n', 2))

    def test_data_13220(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_current_patterns dw 0			; DATA XREF: _read_module+5Fw")), ('0, // _current_patterns\n', 'dw _current_patterns;\n', 2))

    def test_data_13230(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dma_buf_pointer	dd 0			; DATA XREF: _mod_readfile_11F4E+9Cw")), ('0, // _dma_buf_pointer\n', 'dd _dma_buf_pointer;\n', 4))

    def test_data_13240(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dma_channel	db 0			; DATA XREF: _read_sndsettings+11r")), ('0, // _dma_channel\n', 'db _dma_channel;\n', 1))

    def test_data_13250(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dma_channel2	db 0			; DATA XREF: _wss_init:loc_147DCw")), ('0, // _dma_channel2\n', 'db _dma_channel2;\n', 1))

    def test_data_13260(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dma_channel_0	db 0			; DATA XREF: _mod_readfile_11F4E+8Er")), ('0, // _dma_channel_0\n', 'db _dma_channel_0;\n', 1))

    def test_data_13270(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dma_channel_1	db 0FFh			; DATA XREF: _callsubx+Br _callsubx+4Dw")), ('255, // _dma_channel_1\n', 'db _dma_channel_1;\n', 1))

    def test_data_13280(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dma_chn_mask	db 0			; DATA XREF: _sb16_init+4Bw")), ('0, // _dma_chn_mask\n', 'db _dma_chn_mask;\n', 1))

    def test_data_13290(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dma_mode	db 0			; DATA XREF: _proaud_set+3w _wss_set+3w	...")), ('0, // _dma_mode\n', 'db _dma_mode;\n', 1))
    ...
    def test_data_13310(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_dword_1DE2C	dd 0			; DATA XREF: _text_init2+22Aw")), ('0, // _dword_1de2c\n', 'dd _dword_1de2c;\n', 4))
    ...
    def test_data_13350(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_ems_enabled	db 0			; DATA XREF: _ems_initw	_ems_init+78w ...")), ('0, // _ems_enabled\n', 'db _ems_enabled;\n', 1))

    def test_data_13360(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_ems_handle	dw 0			; DATA XREF: _ems_init+74w")), ('0, // _ems_handle\n', 'dw _ems_handle;\n', 2))

    def test_data_13370(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_ems_log_pagenum	dw 0			; DATA XREF: _ems_init+7Dw")), ('0, // _ems_log_pagenum\n', 'dw _ems_log_pagenum;\n', 2))

    def test_data_13380(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_ems_pageframe	dw 0			; DATA XREF: _useless_11787+3Er")), ('0, // _ems_pageframe\n', 'dw _ems_pageframe;\n', 2))

    def test_data_13390(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_esseg_atstart	dw 0			; DATA XREF: _start+5w _parse_cmdline+7r ...")), ('0, // _esseg_atstart\n', 'dw _esseg_atstart;\n', 2))
    ...
    def test_data_13410(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_fhandle_1DE68	dw 0			; DATA XREF: _init_vga_waves+42w")), ('0, // _fhandle_1de68\n', 'dw _fhandle_1de68;\n', 2))

    def test_data_13420(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_fhandle_module	dw 0			; DATA XREF: _moduleread+19w")), ('0, // _fhandle_module\n', 'dw _fhandle_module;\n', 2))

    def test_data_13430(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_flag_playsetttings db 0			; DATA XREF: _clean_11C43+68r")), ('0, // _flag_playsetttings\n', 'db _flag_playsetttings;\n', 1))

    def test_data_13440(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_flg_play_settings db 0			; DATA XREF: _keyb_screen_loop+2Fw")), ('0, // _flg_play_settings\n', 'db _flg_play_settings;\n', 1))
 ...
 'char _frameborder[37];\n',
    ...
    def test_data_13460(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_freq1		dw 22050		; DATA XREF: _volume_prepare_waves+48r")), ('22050, // _freq1\n', 'dw _freq1;\n', 2))

    def test_data_13470(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_freq2		dw 0			; DATA XREF: _read_sndsettings+2Cr")), ('0, // _freq2\n', 'dw _freq2;\n', 2))

    def test_data_13480(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_freq_1DCF6	db 2Ch			; DATA XREF: _callsubx+Fr _callsubx+51w")), ('44, // _freq_1dcf6\n', 'db _freq_1dcf6;\n', 1))

    def test_data_13490(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_freq_245DE	dw 0			; DATA XREF: _mod_1024A+40r")), ('0, // _freq_245de\n', 'dw _freq_245de;\n', 2))

    def test_data_13500(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_freq_246D7	db 0			; DATA XREF: _read_sndsettings+15r")), ('0, // _freq_246d7\n', 'db _freq_246d7;\n', 1))

    def test_data_13510(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_gravis_port	dw 0			; DATA XREF: _volume_prep+61r")), ('0, // _gravis_port\n', 'dw _gravis_port;\n', 2))

    def test_data_13520(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_gravis_txt	db    1			; DATA XREF: seg003:_sndcards_text_tblo")), ('1, // _gravis_txt\n', 'db _gravis_txt;\n', 1))
    ...
    def test_data_13540(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_int1Avect	dd 0			; DATA XREF: _int1a_timer+12r")), ('0, // _int1avect\n', 'dd _int1avect;\n', 4))

    def test_data_13550(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_int8addr	dd 0			; DATA XREF: sub_12DA8+6Aw")), ('0, // _int8addr\n', 'dd _int8addr;\n', 4))

    def test_data_13560(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_interrupt_mask	dw 0			; DATA XREF: _setsnd_handler+Cw")), ('0, // _interrupt_mask\n', 'dw _interrupt_mask;\n', 2))

    def test_data_13570(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_intvectoffset	dw 0			; DATA XREF: _setsnd_handler+2Dw")), ('0, // _intvectoffset\n', 'dw _intvectoffset;\n', 2))

    def test_data_13580(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_irq_number	db 0			; DATA XREF: _read_sndsettings+Dr")), ('0, // _irq_number\n', 'db _irq_number;\n', 1))

    def test_data_13590(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_irq_number2	db 0			; DATA XREF: _wss_init:loc_147D0w")), ('0, // _irq_number2\n', 'db _irq_number2;\n', 1))

    def test_data_13600(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_irq_number_0	db 0			; DATA XREF: _gravis_init+35w")), ('0, // _irq_number_0\n', 'db _irq_number_0;\n', 1))

    def test_data_13610(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_irq_number_1	db 0FFh			; DATA XREF: _callsubx+7r _callsubx+49w")), ('255, // _irq_number_1\n', 'db _irq_number_1;\n', 1))

    def test_data_13620(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_is_stereo	db 0			; DATA XREF: sub_1265D+33r")), ('0, // _is_stereo\n', 'db _is_stereo;\n', 1))

    def test_data_13630(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_key_code	dw 0			; DATA XREF: _start:loc_193FFr")), ('0, // _key_code\n', 'dw _key_code;\n', 2))

    def test_data_13640(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_keyb_switches	dw 0			; DATA XREF: _start+5D8r")), ('0, // _keyb_switches\n', 'dw _keyb_switches;\n', 2))

    def test_data_13650(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_memflg_2469A	db 0			; DATA XREF: _alloc_dma_buf+8w")), ('0, // _memflg_2469a\n', 'db _memflg_2469a;\n', 1))

    def test_data_13660(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_messagepointer	dd 0			; DATA XREF: _start+228r _start+23Dw ...")), ('0, // _messagepointer\n', 'dd _messagepointer;\n', 4))

    def test_data_13670(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_midi_txt	db    2			; DATA XREF: seg003:0D84o")), ('2, // _midi_txt\n', 'db _midi_txt;\n', 1))

    def test_data_13680(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_mod_channels_number	dw 0			; DATA XREF: _moduleread+81r")), ('0, // _mod_channels_number\n', 'dw _mod_channels_number;\n', 2))
    ...
    def test_data_13710(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_moduleflag_246D0 dw 0			; DATA XREF: _mod_n_t_module+3Dw")), ('0, // _moduleflag_246d0\n', 'dw _moduleflag_246d0;\n', 2))

    def test_data_13720(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_mouse_exist_flag db 0			; DATA XREF: _mouse_init:loc_1C6EFw")), ('0, // _mouse_exist_flag\n', 'db _mouse_exist_flag;\n', 1))
    ...
    def test_data_13740(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_mousecolumn	dw 0			; DATA XREF: _start+7A0r _start+7BCr ...")), ('0, // _mousecolumn\n', 'dw _mousecolumn;\n', 2))

    def test_data_13750(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_mouserow	dw 0			; DATA XREF: _start+7A3r _start+7BFr ...")), ('0, // _mouserow\n', 'dw _mouserow;\n', 2))
    ...
    def test_data_13770(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_multip_244CC	dd 0			; DATA XREF: _spectr_1B084+2Fw")), ('0, // _multip_244cc\n', 'dd _multip_244cc;\n', 4))

    def test_data_13780(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_multip_244D0	dd 0			; DATA XREF: _spectr_1B084+25w")), ('0, // _multip_244d0\n', 'dd _multip_244d0;\n', 4))
    ...
    def test_data_13800(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_my_seg_index	dw 0			; DATA XREF: _psm_module+136r")), ('0, // _my_seg_index\n', 'dw _my_seg_index;\n', 2))

    def test_data_13810(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_my_size		dw 0			; DATA XREF: _volume_prep+9w")), ('0, // _my_size\n', 'dw _my_size;\n', 2))
    ...
    def test_data_13830(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_myin		dd ?			; DATA XREF: _mtm_module+22o")), ('0, // _myin\n', 'dd _myin;\n', 4))
    ...
    def test_data_13850(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_myseg_24698	dw 0			; DATA XREF: _alloc_dma_buf+31w")), ('0, // _myseg_24698\n', 'dw _myseg_24698;\n', 2))
    ...
    def test_data_13890(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_oint24_1C1AC	dd 0			; DATA XREF: _start+115w _start+1D4r ...")), ('0, // _oint24_1c1ac\n', 'dd _oint24_1c1ac;\n', 4))

    def test_data_13900(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_oint2f_1C1B4	dd 0			; DATA XREF: _start+124w _start+1C8r ...")), ('0, // _oint2f_1c1b4\n', 'dd _oint2f_1c1b4;\n', 4))

    def test_data_13910(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_oint8off_1DE14	dw 0			; DATA XREF: _start+F9w")), ('0, // _oint8off_1de14\n', 'dw _oint8off_1de14;\n', 2))

    def test_data_13920(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_oint8seg_1DE16	dw 0			; DATA XREF: _start+FDw")), ('0, // _oint8seg_1de16\n', 'dw _oint8seg_1de16;\n', 2))

    def test_data_13930(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_oint9_1C1A4	dd 0			; DATA XREF: _start+106w _start+1E0r ...")), ('0, // _oint9_1c1a4\n', 'dd _oint9_1c1a4;\n', 4))

    def test_data_13940(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_old_intprocoffset dw 0			; DATA XREF: _setsnd_handler+3Aw")), ('0, // _old_intprocoffset\n', 'dw _old_intprocoffset;\n', 2))

    def test_data_13950(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_old_intprocseg	dw 0			; DATA XREF: _setsnd_handler+3Ew")), ('0, // _old_intprocseg\n', 'dw _old_intprocseg;\n', 2))

    def test_data_13960(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_outp_freq	dw 0			; DATA XREF: _read_module+82w")), ('0, // _outp_freq\n', 'dw _outp_freq;\n', 2))

    def test_data_13970(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_palette_24404	db    0			; DATA XREF: _init_vga_waves+17o")), ('0, // _palette_24404\n', 'db _palette_24404;\n', 1))
    ...
    def test_data_13990(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_pcspeaker_txt	db    2			; DATA XREF: seg003:0D80o seg003:0D82o")), ('2, // _pcspeaker_txt\n', 'db _pcspeaker_txt;\n', 1))

    def test_data_14000(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_play_state	db 0			; DATA XREF: _getset_playstate+Bw")), ('0, // _play_state\n', 'db _play_state;\n', 1))

    def test_data_14010(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_pointer_245B4	dd 0			; DATA XREF: sub_135CA+1Cr")), ('0, // _pointer_245b4\n', 'dd _pointer_245b4;\n', 4))

    def test_data_14020(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_prev_scan_code	db 0			; DATA XREF: _int9_keyb+19r")), ('0, // _prev_scan_code\n', 'db _prev_scan_code;\n', 1))
    ...
    def test_data_14060(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_samples_outoffs_24600	dw 0			; DATA XREF: sub_12EBA+2Cw")), ('0, // _samples_outoffs_24600\n', 'dw _samples_outoffs_24600;\n', 2))

    def test_data_14070(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_savesp_245D0	dw 0			; DATA XREF: _moduleread+15w")), ('0, // _savesp_245d0\n', 'dw _savesp_245d0;\n', 2))

    def test_data_14080(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sb16_txt	db    2			; DATA XREF: seg003:0D72o seg003:0D74o ...")), ('2, // _sb16_txt\n', 'db _sb16_txt;\n', 1))

    def test_data_14090(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sb_base_port	dw 0			; DATA XREF: _sb16_on+17r _sb16_on+44r ...")), ('0, // _sb_base_port\n', 'dw _sb_base_port;\n', 2))

    def test_data_14100(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sb_int_counter	db 0			; DATA XREF: _sb_test_interruptw")), ('0, // _sb_int_counter\n', 'db _sb_int_counter;\n', 1))

    def test_data_14110(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sb_irq_number	db 0			; DATA XREF: _sb16_init+1Cw")), ('0, // _sb_irq_number\n', 'db _sb_irq_number;\n', 1))

    def test_data_14120(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sb_timeconst	db 0			; DATA XREF: _sbpro_init+51w _sb_set-D1r ...")), ('0, // _sb_timeconst\n', 'db _sb_timeconst;\n', 1))
    ...
    def test_data_14150(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_snd_base_port	dw 0			; DATA XREF: _read_sndsettings+9r")), ('0, // _snd_base_port\n', 'dw _snd_base_port;\n', 2))
    ...
    def test_data_14170(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_snd_card_type	db 3			; DATA XREF: _text_init2+18Er")), ('3, // _snd_card_type\n', 'db _snd_card_type;\n', 1))
    ...
    def test_data_14190(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_snd_init	db 0			; DATA XREF: sub_12D05+Br")), ('0, // _snd_init\n', 'db _snd_init;\n', 1))

    def test_data_14200(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_snd_set_flag	db 0			; DATA XREF: sub_12DA8+60w _snd_on+7r ...")), ('0, // _snd_set_flag\n', 'db _snd_set_flag;\n', 1))

    def test_data_14210(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sndcard_type	db 0			; DATA XREF: _mtm_module+2Er")), ('0, // _sndcard_type\n', 'db _sndcard_type;\n', 1))

    def test_data_14220(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sndflags_24622	db 0			; DATA XREF: _useless_11787+9r")), ('0, // _sndflags_24622\n', 'db _sndflags_24622;\n', 1))

    def test_data_14230(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_sound_port	dw 0			; DATA XREF: _proaud_init+42w")), ('0, // _sound_port\n', 'dw _sound_port;\n', 2))

    def test_data_14240(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_swapdata_off	dw 0			; DATA XREF: _start+161w")), ('0, // _swapdata_off\n', 'dw _swapdata_off;\n', 2))

    def test_data_14250(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_swapdata_seg	dw 0			; DATA XREF: _start+165w")), ('0, // _swapdata_seg\n', 'dw _swapdata_seg;\n', 2))
    ...
    def test_data_14280(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_table_246F6	dw 8363,8422,8482,8543,8604,8667,8730,8794,7901,7954,8007")), ('{8363,8422,8482,8543,8604,8667,8730,8794,7901,7954,8007}, // _table_246f6\n', 'dw _table_246f6[11];\n', 22))
    ...
    def test_data_14410(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_timer_word_14F6E dw 0			; DATA XREF: _set_timerw _text:4F59r")), ('0, // _timer_word_14f6e\n', 'dw _timer_word_14f6e;\n', 2))
    ...
    def test_data_14430(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_videomempointer	dd 0			; DATA XREF: _start:loc_1917Dw")), ('0, // _videomempointer\n', 'dd _videomempointer;\n', 4))

    def test_data_14440(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_videopoint_shiftd dd 0			; DATA XREF: _text_init2+5Fw")), ('0, // _videopoint_shiftd\n', 'dd _videopoint_shiftd;\n', 4))

    def test_data_14450(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_volume_1DE34	dd 0			; DATA XREF: _read_module+DAw")), ('0, // _volume_1de34\n', 'dd _volume_1de34;\n', 4))
    ...
    def test_data_14590(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_word_1D669	dw 2020h		; DATA XREF: _useless_197F2+12w")), ('8224, // _word_1d669\n', 'dw _word_1d669;\n', 2))
    ...
    def test_data_14630(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_word_257A4	dw 0			; DATA XREF: _useless_writeinr+106w")), ('0, // _word_257a4\n', 'dw _word_257a4;\n', 2))

    def test_data_14640(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_word_257E6	dw 4			; DATA XREF: _useless_writeinr+53w")), ('4, // _word_257e6\n', 'dw _word_257e6;\n', 2))

    def test_data_14650(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_word_257E8	dw 0			; DATA XREF: _useless_writeinr+59w")), ('0, // _word_257e8\n', 'dw _word_257e8;\n', 2))
    ...
    def test_data_14670(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="_wss_freq_table	dw 5513			; DATA XREF: _wss_test+3Er")), ('5513, // _wss_freq_table\n', 'dw _wss_freq_table;\n', 2))
    ...
    def test_data_14790(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="audio_len	dw 0			; DATA XREF: _configure_timer+1Bw")), ('0, // audio_len\n', 'dw audio_len;\n', 2))
    ...
    def test_data_15660(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="str1 db 'abcde'")), ("{'a','b','c','d','e'}, // str1\n", 'char str1[5];\n', 5))

    def test_data_15670(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="str2 db 'abcde'")), ("{'a','b','c','d','e'}, // str2\n", 'char str2[5];\n', 5))

    def test_data_15680(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="str3 db 'cdeab'")), ("{'c','d','e','a','b'}, // str3\n", 'char str3[5];\n', 5))
    ...
    def test_data_15720(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="unk_16464	db    0			; DATA XREF: sub_1609F+235w")), ('0, // unk_16464\n', 'db unk_16464;\n', 1))

    def test_data_15730(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="unk_165AD	db    0			; DATA XREF: sub_1609F+251w")), ('0, // unk_165ad\n', 'db unk_165ad;\n', 1))
    ...
    def test_data_15750(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="unk_1D6C3	db    2			; DATA XREF: seg001:1BDAo")), ('2, // unk_1d6c3\n', 'db unk_1d6c3;\n', 1))

    def test_data_15760(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="unk_1DC01	db    0			; DATA XREF: _modules_search+8Fr")), ('0, // unk_1dc01\n', 'db unk_1dc01;\n', 1))
    ...
    def test_data_15780(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="unk_244C4	db    0			; DATA XREF: _spectr_1B084+14Ew")), ('0, // unk_244c4\n', 'db unk_244c4;\n', 1))
    ...
    def test_data_15900(self):
        self.assertEqual(self.cpp.produce_c_data_single(self.parser.action_data(line="var5 db 'abcd'")), ("{'a','b','c','d'}, // var5\n", 'char var5[4];\n', 4))
