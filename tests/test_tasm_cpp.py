...
class CppTest(unittest.TestCase):
    ...
    def test_get_size(self, mock_debug):
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'(1024*10/16)+5'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'(1024*10/16)-1'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'+0x40'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'+0x4000'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'001111111B'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'00fffh'),2)
        self.assertEqual(cpp_instance.get_size(expr=u'00h'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'0100b'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'01010101010101010b'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'0101010101010101b'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'0101b'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'010B'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'011111100B'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'011111111111111111111111111111111b'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'01111111111111111b'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'011111111B'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'012345678h'),4)
        self.assertEqual(cpp_instance.get_size(expr=u'01B'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'0B'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'0ffffh'),2)
        self.assertEqual(cpp_instance.get_size(expr=u'0ffh'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'0x0C'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'0x10'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'0x14'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'1024*10/16'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'1024*1024'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'10B'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'14*320'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'256*3'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'256+3'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'256+3+65536'),0)
        self.assertEqual(cpp_instance.get_size(expr=u'26'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'27'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'28'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'29'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'2Ch'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'2Dh'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'3'),1)
        self.assertEqual(cpp_instance.get_size(expr=u'3*4'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'320*200/4'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'4+5*256'),0)
        ...
        self.assertEqual(cpp_instance.get_size(expr=u'6*256+5'),0)
    ...
    def test_convert_number(self):
        ...
        self.assertEqual(cpp.convert_number_to_c(expr=u'0FFFFFFFBh'), u'0x0FFFFFFFB')
        self.assertEqual(cpp.convert_number_to_c(expr=u'0FFFFFFFCh'), u'0x0FFFFFFFC')
        self.assertEqual(cpp.convert_number_to_c(expr=u'0FFFFFFFDh'), u'0x0FFFFFFFD')
        self.assertEqual(cpp.convert_number_to_c(expr=u'0FFFFFFFEh'), u'0x0FFFFFFFE')
        ...
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340128h'), u'0x12340128')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340205h'), u'0x12340205')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340306h'), u'0x12340306')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340407h'), u'0x12340407')
        self.assertEqual(cpp.convert_number_to_c(expr=u'1234040Ah'), u'0x1234040A')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340503h'), u'0x12340503')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340506h'), u'0x12340506')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340507h'), u'0x12340507')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340547h'), u'0x12340547')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340559h'), u'0x12340559')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12340560h'), u'0x12340560')
        self.assertEqual(cpp.convert_number_to_c(expr=u'1234059Fh'), u'0x1234059F')
        self.assertEqual(cpp.convert_number_to_c(expr=u'123405A0h'), u'0x123405A0')
        self.assertEqual(cpp.convert_number_to_c(expr=u'123405FAh'), u'0x123405FA')
        self.assertEqual(cpp.convert_number_to_c(expr=u'12341678h'), u'0x12341678')
