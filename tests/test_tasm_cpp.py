...
class CppTest(unittest.TestCase):
    ...
    def test_expand(self, mock_debug):
        ...
        #self.assertEqual(cpp_instance.expand(expr=u'(offset str_buffer+800h)',def_size=4,destination=False),u'str_buffer+0x800')
    ...
    def test_expand_new(self, mock_debug):
        ...
        p.set_global("_data", op.var(1, 0, issegment=True))
        cpp_instance = Cpp(p)
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u"'Z' - 'A' +1"),def_size=1,destination=False),u"'Z'-'A'+1")
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u"'a'"),def_size=1,destination=False),u"'a'")
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'(1024*10/16)+5'),def_size=2,destination=False),u'(1024*10/16)+5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'(1024*10/16)-1'),def_size=2,destination=False),u'(1024*10/16)-1')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'(offset str_buffer+800h)'),def_size=4,destination=False),u'str_buffer+0x800')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'(offset str_buffer+810h)'),def_size=0,destination=False),u'offset(_bss,str_buffer)+0x810')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'(offset str_buffer+810h)'),def_size=4,destination=False),u'offset(_bss,str_buffer)+0x810')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+0x40'),def_size=0,destination=False),u'+0x40')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+0x4000'),def_size=0,destination=False),u'+0x4000')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx'),def_size=0,destination=False),u'+ecx')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx*2'),def_size=0,destination=False),u'+ecx*2')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx*2+0x4000'),def_size=0,destination=False),u'+ecx*2+0x4000')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx*2-0x0A'),def_size=0,destination=False),u'+ecx*2-0x0A')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx*4'),def_size=0,destination=False),u'+ecx*4')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx*4+0x4000'),def_size=0,destination=False),u'+ecx*4+0x4000')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx*4-0x0A'),def_size=0,destination=False),u'+ecx*4-0x0A')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+ecx+0x40'),def_size=0,destination=False),u'+ecx+0x40')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+edx'),def_size=0,destination=False),u'+edx')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'+edx+0x4000'),def_size=0,destination=False),u'+edx+0x4000')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-0x108'),def_size=0,destination=False),u'-0x108')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-0x1C'),def_size=0,destination=False),u'-0x1C')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-0x20'),def_size=0,destination=False),u'-0x20')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-0x28'),def_size=0,destination=False),u'-0x28')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-0x2C'),def_size=0,destination=False),u'-0x2C')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-1'),def_size=1,destination=False),u'-1')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-1'),def_size=2,destination=False),u'-1')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-1'),def_size=4,destination=False),u'-1')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-1-(-2+3)'),def_size=4,destination=False),u'-1-(-2+3)')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-12'),def_size=4,destination=False),u'-12')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-13'),def_size=4,destination=False),u'-13')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-2'),def_size=1,destination=False),u'-2')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-2'),def_size=4,destination=False),u'-2')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-2Dh'),def_size=2,destination=False),u'-0x2D')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-2Dh'),def_size=4,destination=False),u'-0x2D')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-4'),def_size=0,destination=False),u'-4')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-4'),def_size=4,destination=False),u'-4')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-5'),def_size=1,destination=False),u'-5')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-5'),def_size=2,destination=False),u'-5')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-5'),def_size=4,destination=False),u'-5')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'-8'),def_size=4,destination=False),u'-8')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0'),def_size=0,destination=False),u'0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0'),def_size=1,destination=False),u'0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0002h'),def_size=1,destination=False),u'0x0002')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0007'),def_size=1,destination=False),u'0007')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'000f3h'),def_size=1,destination=False),u'0x000f3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'000ff00ffh'),def_size=4,destination=False),u'0x000ff00ff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'001111111B'),def_size=1,destination=False),u'0x7f')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'00fffh'),def_size=2,destination=False),u'0x00fff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'00h'),def_size=1,destination=False),u'0x00')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0100b'),def_size=4,destination=False),u'0x4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'01010101010101010b'),def_size=2,destination=False),u'0xaaaa')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0101010101010101b'),def_size=4,destination=False),u'0x5555')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0101b'),def_size=4,destination=False),u'0x5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'010B'),def_size=1,destination=False),u'0x2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'010B'),def_size=4,destination=False),u'0x2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'011111100B'),def_size=1,destination=False),u'0xfc')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'011111111111111111111111111111111b'),def_size=4,destination=False),u'0xffffffff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'01111111111111111b'),def_size=2,destination=False),u'0xffff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'011111111B'),def_size=1,destination=False),u'0xff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'012345678h'),def_size=4,destination=False),u'0x012345678')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'01B'),def_size=4,destination=False),u'0x1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'01h'),def_size=1,destination=False),u'0x01')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'02h'),def_size=1,destination=False),u'0x02')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'03dh'),def_size=1,destination=False),u'0x03d')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'03eh'),def_size=1,destination=False),u'0x03e')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'03fh'),def_size=1,destination=False),u'0x03f')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'042h'),def_size=1,destination=False),u'0x042')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'077123456h'),def_size=4,destination=False),u'0x077123456')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'077aaFF00h'),def_size=4,destination=False),u'0x077aaFF00')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'08h'),def_size=1,destination=False),u'0x08')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0B'),def_size=1,destination=False),u'0x0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0BC6058h'),def_size=0,destination=False),u'0x0BC6058')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0D5h'),def_size=1,destination=False),u'0x0D5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0Eh'),def_size=1,destination=False),u'0x0E')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0F7h'),def_size=1,destination=False),u'0x0F7')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FBCA7654h'),def_size=4,destination=False),u'0x0FBCA7654')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FBCA7h'),def_size=4,destination=False),u'0x0FBCA7')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FEh'),def_size=1,destination=False),u'0x0FE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFEh'),def_size=2,destination=False),u'0x0FFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFC70F9h'),def_size=4,destination=False),u'0x0FFFC70F9')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFE0080h'),def_size=4,destination=False),u'0x0FFFE0080')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFEDCBFh'),def_size=4,destination=False),u'0x0FFFEDCBF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFEFDFCh'),def_size=4,destination=False),u'0x0FFFEFDFC')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFEh'),def_size=2,destination=False),u'0x0FFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFF7FFFh'),def_size=4,destination=False),u'0x0FFFF7FFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFA549h'),def_size=4,destination=False),u'0x0FFFFA549')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFEh'),def_size=4,destination=False),u'0x0FFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFED4h'),def_size=4,destination=False),u'0x0FFFFFED4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFEh'),def_size=4,destination=False),u'0x0FFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFD3h'),def_size=4,destination=False),u'0x0FFFFFFD3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFECh'),def_size=4,destination=False),u'0x0FFFFFFEC')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFEh'),def_size=4,destination=False),u'0x0FFFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFF0h'),def_size=4,destination=False),u'0x0FFFFFFF0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFF7h'),def_size=4,destination=False),u'0x0FFFFFFF7')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFFAh'),def_size=4,destination=False),u'0x0FFFFFFFA')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFFBh'),def_size=4,destination=False),u'0x0FFFFFFFB')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFFCh'),def_size=4,destination=False),u'0x0FFFFFFFC')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFFDh'),def_size=4,destination=False),u'0x0FFFFFFFD')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFFEh'),def_size=4,destination=False),u'0x0FFFFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFFFh'),def_size=4,destination=False),u'0x0FFFFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFFh'),def_size=4,destination=False),u'0x0FFFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFFh'),def_size=4,destination=False),u'0x0FFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFFh'),def_size=4,destination=False),u'0x0FFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFFh'),def_size=2,destination=False),u'0x0FFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFFh'),def_size=2,destination=False),u'0x0FFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0FFh'),def_size=1,destination=False),u'0x0FF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0Fh'),def_size=1,destination=False),u'0x0F')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0a0000h'),def_size=4,destination=False),u'0x0a0000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0a000h'),def_size=2,destination=False),u'0x0a000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0aabbccddh'),def_size=4,destination=False),u'0x0aabbccdd')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0abcdef77h'),def_size=4,destination=False),u'0x0abcdef77')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0af222h'),def_size=4,destination=False),u'0x0af222')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0cch'),def_size=1,destination=False),u'0x0cc')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ddh'),def_size=1,destination=False),u'0x0dd')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0df01h'),def_size=2,destination=False),u'0x0df01')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0dff1h'),def_size=2,destination=False),u'0x0dff1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0f0ffh'),def_size=2,destination=False),u'0x0f0ff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0f0h'),def_size=1,destination=False),u'0x0f0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0f222h'),def_size=2,destination=False),u'0x0f222')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffff0003h'),def_size=4,destination=False),u'0x0ffff0003')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffff00f3h'),def_size=4,destination=False),u'0x0ffff00f3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffff01ffh'),def_size=4,destination=False),u'0x0ffff01ff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffffff00h'),def_size=4,destination=False),u'0x0ffffff00')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffffff03h'),def_size=4,destination=False),u'0x0ffffff03')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0fffffff3h'),def_size=4,destination=False),u'0x0fffffff3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffffffffh'),def_size=4,destination=False),u'0x0ffffffff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffffh'),def_size=2,destination=False),u'0x0ffff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'0ffh'),def_size=1,destination=False),u'0x0ff')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1'),def_size=0,destination=False),u'1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1'),def_size=1,destination=False),u'1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'10'),def_size=1,destination=False),u'10')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'10000h'),def_size=4,destination=False),u'0x10000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1000h'),def_size=2,destination=False),u'0x1000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'100h'),def_size=2,destination=False),u'0x100')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1024*10/16'),def_size=2,destination=False),u'1024*10/16')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1024*1024'),def_size=4,destination=False),u'1024*1024')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'10B'),def_size=4,destination=False),u'0x2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'10h'),def_size=0,destination=False),u'0x10')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'10h'),def_size=1,destination=False),u'0x10')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'11'),def_size=1,destination=False),u'11')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'111'),def_size=1,destination=False),u'111')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'114h'),def_size=2,destination=False),u'0x114')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'11h'),def_size=1,destination=False),u'0x11')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12'),def_size=1,destination=False),u'12')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340004h'),def_size=4,destination=False),u'0x12340004')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1234001Dh'),def_size=4,destination=False),u'0x1234001D')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340128h'),def_size=4,destination=False),u'0x12340128')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340205h'),def_size=4,destination=False),u'0x12340205')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340306h'),def_size=4,destination=False),u'0x12340306')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340407h'),def_size=4,destination=False),u'0x12340407')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1234040Ah'),def_size=4,destination=False),u'0x1234040A')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340503h'),def_size=4,destination=False),u'0x12340503')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340506h'),def_size=4,destination=False),u'0x12340506')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340507h'),def_size=4,destination=False),u'0x12340507')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340547h'),def_size=4,destination=False),u'0x12340547')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340559h'),def_size=4,destination=False),u'0x12340559')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12340560h'),def_size=4,destination=False),u'0x12340560')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1234059Fh'),def_size=4,destination=False),u'0x1234059F')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'123405A0h'),def_size=4,destination=False),u'0x123405A0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'123405FAh'),def_size=4,destination=False),u'0x123405FA')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12341678h'),def_size=4,destination=False),u'0x12341678')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12341h'),def_size=4,destination=False),u'0x12341')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12343h'),def_size=4,destination=False),u'0x12343')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12345'),def_size=2,destination=False),u'12345')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1234561Dh'),def_size=4,destination=False),u'0x1234561D')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12345678h'),def_size=4,destination=False),u'0x12345678')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12345h'),def_size=4,destination=False),u'0x12345')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12347F7Fh'),def_size=4,destination=False),u'0x12347F7F')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12347FFFh'),def_size=4,destination=False),u'0x12347FFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12348000h'),def_size=4,destination=False),u'0x12348000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12348080h'),def_size=4,destination=False),u'0x12348080')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1234h'),def_size=2,destination=False),u'0x1234')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'127Eh'),def_size=2,destination=False),u'0x127E')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'12Ch'),def_size=2,destination=False),u'0x12C')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'13'),def_size=1,destination=False),u'13')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'132'),def_size=1,destination=False),u'132')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'133'),def_size=1,destination=False),u'133')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'13h'),def_size=1,destination=False),u'0x13')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'14'),def_size=1,destination=False),u'14')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'14*320'),def_size=4,destination=False),u'14*320')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'14h'),def_size=1,destination=False),u'0x14')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'15'),def_size=1,destination=False),u'15')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'16'),def_size=1,destination=False),u'16')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'17'),def_size=1,destination=False),u'17')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'17h'),def_size=1,destination=False),u'0x17')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'18'),def_size=1,destination=False),u'18')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'18h'),def_size=1,destination=False),u'0x18')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'19'),def_size=1,destination=False),u'19')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'192'),def_size=1,destination=False),u'192')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'193'),def_size=1,destination=False),u'193')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1Ch'),def_size=1,destination=False),u'0x1C')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1Eh'),def_size=1,destination=False),u'0x1E')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FEh'),def_size=2,destination=False),u'0x1FE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FF7Fh'),def_size=4,destination=False),u'0x1FF7F')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FF80h'),def_size=4,destination=False),u'0x1FF80')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FF81h'),def_size=4,destination=False),u'0x1FF81')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFEh'),def_size=2,destination=False),u'0x1FFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFEh'),def_size=4,destination=False),u'0x1FFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFFEh'),def_size=4,destination=False),u'0x1FFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFFFEh'),def_size=4,destination=False),u'0x1FFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFFFFEh'),def_size=4,destination=False),u'0x1FFFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFFFFFh'),def_size=4,destination=False),u'0x1FFFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFFFFh'),def_size=4,destination=False),u'0x1FFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFFFh'),def_size=4,destination=False),u'0x1FFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFFh'),def_size=4,destination=False),u'0x1FFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFFh'),def_size=2,destination=False),u'0x1FFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1FFh'),def_size=2,destination=False),u'0x1FF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'1Fh'),def_size=1,destination=False),u'0x1F')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'2'),def_size=0,destination=False),u'2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'2'),def_size=1,destination=False),u'2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'20'),def_size=1,destination=False),u'20')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'20000h'),def_size=4,destination=False),u'0x20000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'20h'),def_size=1,destination=False),u'0x20')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'21'),def_size=1,destination=False),u'21')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'21AD3D34h'),def_size=4,destination=False),u'0x21AD3D34')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'21h'),def_size=0,destination=False),u'0x21')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'22'),def_size=1,destination=False),u'22')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'23'),def_size=1,destination=False),u'23')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'24'),def_size=1,destination=False),u'24')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'24h'),def_size=1,destination=False),u'0x24')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'25'),def_size=1,destination=False),u'25')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'255'),def_size=1,destination=False),u'255')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'256'),def_size=2,destination=False),u'256')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'256*3'),def_size=2,destination=False),u'256*3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'256+3'),def_size=2,destination=False),u'256+3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'256+3+65536'),def_size=4,destination=False),u'256+3+65536')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'26'),def_size=1,destination=False),u'26')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'27'),def_size=1,destination=False),u'27')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'28'),def_size=1,destination=False),u'28')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'29'),def_size=1,destination=False),u'29')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'2Ch'),def_size=1,destination=False),u'0x2C')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'2Dh'),def_size=1,destination=False),u'0x2D')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'2Dh'),def_size=2,destination=False),u'0x2D')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'2Dh'),def_size=4,destination=False),u'0x2D')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3'),def_size=0,destination=False),u'3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3'),def_size=1,destination=False),u'3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3*4'),def_size=4,destination=False),u'3*4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'30'),def_size=1,destination=False),u'30')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'303Bh'),def_size=2,destination=False),u'0x303B')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'30h'),def_size=1,destination=False),u'0x30')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'31'),def_size=1,destination=False),u'31')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'31h'),def_size=0,destination=False),u'0x31')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'32'),def_size=1,destination=False),u'32')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'320*200/4'),def_size=4,destination=False),u'320*200/4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'32432434h'),def_size=4,destination=False),u'0x32432434')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'340128h'),def_size=4,destination=False),u'0x340128')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'35'),def_size=1,destination=False),u'35')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'37'),def_size=1,destination=False),u'37')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'39h'),def_size=1,destination=False),u'0x39')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3Ch'),def_size=1,destination=False),u'0x3C')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3DAh'),def_size=2,destination=False),u'0x3DA')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3Eh'),def_size=1,destination=False),u'0x3E')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FEh'),def_size=2,destination=False),u'0x3FE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFEh'),def_size=2,destination=False),u'0x3FFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFEh'),def_size=4,destination=False),u'0x3FFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFFEh'),def_size=4,destination=False),u'0x3FFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFFFEh'),def_size=4,destination=False),u'0x3FFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFFFFEh'),def_size=4,destination=False),u'0x3FFFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFFFFFh'),def_size=4,destination=False),u'0x3FFFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFFFFh'),def_size=4,destination=False),u'0x3FFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFFFh'),def_size=4,destination=False),u'0x3FFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFFh'),def_size=4,destination=False),u'0x3FFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFFh'),def_size=2,destination=False),u'0x3FFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3FFh'),def_size=2,destination=False),u'0x3FF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3Fh'),def_size=1,destination=False),u'0x3F')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3c8h'),def_size=2,destination=False),u'0x3c8')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3c9h'),def_size=2,destination=False),u'0x3c9')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'3h'),def_size=1,destination=False),u'0x3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'4'),def_size=1,destination=False),u'4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'4+5*256'),def_size=2,destination=False),u'4+5*256')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'4000000'),def_size=4,destination=False),u'4000000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'40h'),def_size=1,destination=False),u'0x40')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'43210123h'),def_size=4,destination=False),u'0x43210123')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'48h'),def_size=1,destination=False),u'0x48')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'49h'),def_size=1,destination=False),u'0x49')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'4Ah'),def_size=1,destination=False),u'0x4A')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'4Ch'),def_size=1,destination=False),u'0x4C')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'4ch'),def_size=1,destination=False),u'0x4c')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'5'),def_size=1,destination=False),u'5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'50'),def_size=1,destination=False),u'50')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'501h'),def_size=2,destination=False),u'0x501')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'511'),def_size=2,destination=False),u'511')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'55'),def_size=1,destination=False),u'55')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'56'),def_size=1,destination=False),u'56')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'57'),def_size=1,destination=False),u'57')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'6'),def_size=1,destination=False),u'6')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'6*256+5'),def_size=2,destination=False),u'6*256+5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'60'),def_size=1,destination=False),u'60')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'65324h'),def_size=4,destination=False),u'0x65324')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'65423456h'),def_size=4,destination=False),u'0x65423456')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'6789ABCDh'),def_size=4,destination=False),u'0x6789ABCD')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7'),def_size=1,destination=False),u'7')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7Eh'),def_size=1,destination=False),u'0x7E')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FEh'),def_size=2,destination=False),u'0x7FE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFEh'),def_size=2,destination=False),u'0x7FFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFEh'),def_size=4,destination=False),u'0x7FFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFFEh'),def_size=4,destination=False),u'0x7FFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFFFEh'),def_size=4,destination=False),u'0x7FFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFFFFEh'),def_size=4,destination=False),u'0x7FFFFFFE')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFFFFFh'),def_size=4,destination=False),u'0x7FFFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFFFFh'),def_size=4,destination=False),u'0x7FFFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFFFh'),def_size=4,destination=False),u'0x7FFFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFFh'),def_size=4,destination=False),u'0x7FFFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFh'),def_size=2,destination=False),u'0x7FFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFFh'),def_size=4,destination=False),u'0x7FFF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7FFh'),def_size=2,destination=False),u'0x7FF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'7Fh'),def_size=1,destination=False),u'0x7F')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8'),def_size=0,destination=False),u'8')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8'),def_size=1,destination=False),u'8')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'80000000h'),def_size=4,destination=False),u'0x80000000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'80000001h'),def_size=4,destination=False),u'0x80000001')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'80008481h'),def_size=4,destination=False),u'0x80008481')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'80008688h'),def_size=4,destination=False),u'0x80008688')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8000h'),def_size=2,destination=False),u'0x8000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8000h'),def_size=4,destination=False),u'0x8000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'801h'),def_size=2,destination=False),u'0x801')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'80h'),def_size=1,destination=False),u'0x80')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'81234567h'),def_size=4,destination=False),u'0x81234567')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'81238567h'),def_size=4,destination=False),u'0x81238567')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'812FADAh'),def_size=4,destination=False),u'0x812FADA')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'813F3421h'),def_size=4,destination=False),u'0x813F3421')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'81h'),def_size=1,destination=False),u'0x81')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'82345679h'),def_size=4,destination=False),u'0x82345679')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8234A6F8h'),def_size=4,destination=False),u'0x8234A6F8')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8345A1F2h'),def_size=4,destination=False),u'0x8345A1F2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8C5h'),def_size=2,destination=False),u'0x8C5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'8D5h'),def_size=2,destination=False),u'0x8D5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'9'),def_size=1,destination=False),u'9')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'9ABCDEFh'),def_size=0,destination=False),u'0x9ABCDEF')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'AL'),def_size=1,destination=True),u'al')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'B'),def_size=4,destination=False),u'B')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'CC'),def_size=4,destination=False),u'CC')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'DDD'),def_size=0,destination=False),u'DDD')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'DX'),def_size=2,destination=True),u'dx')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'OFFSET ASCiI'),def_size=4,destination=False),u'offset(_data,ASCII)')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'OFFSET AsCii'),def_size=4,destination=False),u'offset(_data,ASCII)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'TWO'),def_size=4,destination=False),u'TWO')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ah'),def_size=1,destination=False),u'ah')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ah'),def_size=1,destination=True),u'ah')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'al'),def_size=0,destination=False),u'al')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'al'),def_size=1,destination=False),u'al')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'al'),def_size=1,destination=True),u'al')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ax'),def_size=0,destination=False),u'ax')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ax'),def_size=2,destination=False),u'ax')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ax'),def_size=2,destination=True),u'ax')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'b'),def_size=0,destination=False),u'offset(_data,b)')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'b'),def_size=2,destination=True),u'm.b')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'beginningdata'),def_size=0,destination=False),u'offset(_data,beginningdata)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bh'),def_size=0,destination=False),u'bh')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bh'),def_size=1,destination=False),u'bh')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bh'),def_size=1,destination=True),u'bh')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bl'),def_size=0,destination=False),u'bl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bl'),def_size=1,destination=False),u'bl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bl'),def_size=1,destination=True),u'bl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bp'),def_size=2,destination=False),u'bp')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'buffer'),def_size=0,destination=False),u'offset(_data,buffer)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bx'),def_size=0,destination=False),u'bx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bx'),def_size=2,destination=False),u'bx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'bx'),def_size=2,destination=True),u'bx')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'c'),def_size=4,destination=True),u'm.c')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ch'),def_size=1,destination=True),u'ch')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'cl'),def_size=0,destination=False),u'cl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'cl'),def_size=1,destination=False),u'cl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'cl'),def_size=1,destination=True),u'cl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'cx'),def_size=0,destination=False),u'cx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'cx'),def_size=2,destination=False),u'cx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'cx'),def_size=2,destination=True),u'cx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'di'),def_size=2,destination=False),u'di')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dl'),def_size=0,destination=False),u'dl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dl'),def_size=1,destination=False),u'dl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dl'),def_size=1,destination=True),u'dl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds'),def_size=0,destination=False),u'ds')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds'),def_size=2,destination=True),u'ds')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dx'),def_size=0,destination=False),u'dx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dx'),def_size=2,destination=False),u'dx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dx'),def_size=2,destination=True),u'dx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'eax'),def_size=0,destination=False),u'eax')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'eax'),def_size=4,destination=False),u'eax')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'eax'),def_size=4,destination=True),u'eax')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'eax_0'),def_size=0,destination=False),u'eax_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ebp'),def_size=0,destination=False),u'ebp')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ebp'),def_size=4,destination=False),u'ebp')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ebp'),def_size=4,destination=True),u'ebp')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ebx'),def_size=0,destination=False),u'ebx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ebx'),def_size=4,destination=False),u'ebx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ebx'),def_size=4,destination=True),u'ebx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ecx'),def_size=0,destination=False),u'ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ecx'),def_size=4,destination=False),u'ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ecx'),def_size=4,destination=True),u'ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ecx_0'),def_size=0,destination=False),u'ecx_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ecx_0_0'),def_size=0,destination=False),u'ecx_0_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edi'),def_size=0,destination=False),u'edi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edi'),def_size=4,destination=False),u'edi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edi'),def_size=4,destination=True),u'edi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edi_0'),def_size=0,destination=False),u'edi_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edi_0'),def_size=0,destination=True),u'edi_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edx'),def_size=0,destination=False),u'edx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edx'),def_size=4,destination=False),u'edx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edx'),def_size=4,destination=True),u'edx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edx_0_0'),def_size=0,destination=False),u'edx_0_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'edx_0_0'),def_size=4,destination=True),u'edx_0_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'eflags'),def_size=1,destination=True),u'eflags')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'eflags'),def_size=2,destination=True),u'eflags')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'enddata'),def_size=0,destination=False),u'offset(_data,enddata)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'es'),def_size=0,destination=False),u'es')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'es'),def_size=2,destination=True),u'es')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esi'),def_size=0,destination=False),u'esi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esi'),def_size=4,destination=False),u'esi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esi'),def_size=4,destination=True),u'esi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esi_0'),def_size=0,destination=False),u'esi_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esi_0'),def_size=4,destination=False),u'esi_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esi_0'),def_size=4,destination=True),u'esi_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esp'),def_size=4,destination=False),u'esp')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'esp'),def_size=4,destination=True),u'esp')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'f'),def_size=0,destination=False),u'offset(_data,f)')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'fileName'),def_size=0,destination=False),u'offset(_data,fileName)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'flags'),def_size=0,destination=False),u'flags')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'flags'),def_size=1,destination=True),u'flags')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'flags'),def_size=2,destination=True),u'flags')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'flags'),def_size=4,destination=False),u'flags')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'fs'),def_size=0,destination=False),u'fs')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'fs'),def_size=2,destination=False),u'fs')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'fs'),def_size=2,destination=True),u'fs')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'g'),def_size=4,destination=False),u'm.g')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'i'),def_size=0,destination=False),u'i')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'i'),def_size=0,destination=True),u'i')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'i'),def_size=1,destination=True),u'i')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'i'),def_size=2,destination=True),u'i')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'i'),def_size=4,destination=False),u'i')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'i'),def_size=4,destination=True),u'i')

        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u"'tseT'"),def_size=4,destination=False),u'0x74736554')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[a+1]'),def_size=1,destination=False),u'*(raddr(ds,a+1))')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[a+1]'),def_size=1,destination=False),u'*(raddr(ds,offset(_data,a)+1))')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[a]'),def_size=1,destination=False),u'*(raddr(ds,offset(_data,a)))')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[a]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,a)))')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[cs:table+ax]'),def_size=0,destination=True),u'*(dw*)(raddr(cs,offset(_text,table)+ax))')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[doublequote+4]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,doublequote)+4))')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[eax+4000h]'),def_size=0,destination=False),u'eax+0x4000')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[eax+40h]'),def_size=0,destination=False),u'eax+0x40')
        #self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[eax+ecx+40h]'),def_size=0,destination=False),u'eax+ecx+0x40')
        '''
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[eax+ecx]'),def_size=0,destination=False),u'eax+ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[eax]'),def_size=0,destination=False),u'eax')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+ecx_0]'),def_size=0,destination=True),u'*(dw*)(raddr(ds,ebp+ecx_0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+ecx_0]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+ecx_0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+ecx_vals]'),def_size=0,destination=False),u'ebp+ecx_vals')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+edx_0]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+edx_0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+edx_0]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,ebp+edx_0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+i*4+ecx_vals]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+i*4+ecx_vals))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+i+table]'),def_size=1,destination=True),u'*(raddr(ds,ebp+i+table))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+iflags]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+iflags))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+op0]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+op0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+op0h]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+op0h))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+s0]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+s0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+s0]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,ebp+s0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+s1]'),def_size=1,destination=True),u'*(raddr(ds,ebp+s1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+s1]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+s1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+s2]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+s2))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+s2]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,ebp+s2))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+table]'),def_size=0,destination=False),u'ebp+table')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+var_1C]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+var_1C))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+var_1C]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,ebp+var_1C))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+var_20]'),def_size=0,destination=False),u'*(dw*)(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+var_20]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+var_20]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebp+var_4]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+var_4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebx+4000h]'),def_size=0,destination=False),u'ebx+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebx+40h]'),def_size=0,destination=False),u'ebx+0x40')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebx+edx+4000h]'),def_size=0,destination=False),u'ebx+edx+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebx+edx]'),def_size=0,destination=False),u'ebx+edx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ebx]'),def_size=0,destination=False),u'ebx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ecx+4000h]'),def_size=0,destination=False),u'ecx+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ecx+40h]'),def_size=0,destination=False),u'ecx+0x40')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ecx+ecx*2+4000h]'),def_size=0,destination=False),u'ecx+ecx*2+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ecx+ecx*2-0Ah]'),def_size=0,destination=False),u'ecx+ecx*2-0x0A')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ecx+ecx*2]'),def_size=0,destination=False),u'ecx+ecx*2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ecx+ecx]'),def_size=0,destination=False),u'ecx+ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[ecx]'),def_size=0,destination=False),u'ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edi+1]'),def_size=1,destination=False),u'*(raddr(ds,edi+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edi+1]'),def_size=2,destination=False),u'*(dw*)(raddr(ds,edi+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edi+4000h]'),def_size=0,destination=False),u'edi+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edi+40h]'),def_size=0,destination=False),u'edi+0x40')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edi+ecx]'),def_size=0,destination=False),u'edi+ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edi]'),def_size=0,destination=False),u'edi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edi]'),def_size=1,destination=False),u'*(raddr(ds,edi))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edx+4000h]'),def_size=0,destination=False),u'edx+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edx+40h]'),def_size=0,destination=False),u'edx+0x40')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edx+ecx*4+4000h]'),def_size=0,destination=False),u'edx+ecx*4+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edx+ecx*4-0Ah]'),def_size=0,destination=False),u'edx+ecx*4-0x0A')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edx+ecx*4]'),def_size=0,destination=False),u'edx+ecx*4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edx+ecx]'),def_size=0,destination=False),u'edx+ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[edx]'),def_size=0,destination=False),u'edx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esi+4000h]'),def_size=0,destination=False),u'esi+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esi+40h]'),def_size=0,destination=False),u'esi+0x40')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esi+ecx*8+4000h]'),def_size=0,destination=False),u'esi+ecx*8+0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esi+ecx*8-0Ah]'),def_size=0,destination=False),u'esi+ecx*8-0x0A')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esi+ecx*8]'),def_size=0,destination=False),u'esi+ecx*8')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esi+ecx]'),def_size=0,destination=False),u'esi+ecx')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esi]'),def_size=0,destination=False),u'esi')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+0Ch]'),def_size=0,destination=True),u'*(dw*)(raddr(ds,esp+0x0C))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+0Ch]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x0C))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+10h]'),def_size=0,destination=True),u'*(dw*)(raddr(ds,esp+0x10))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+10h]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x10))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+14h]'),def_size=0,destination=True),u'*(dw*)(raddr(ds,esp+0x14))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+14h]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x14))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+18h]'),def_size=0,destination=True),u'*(dw*)(raddr(ds,esp+0x18))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+18h]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x18))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+1Ch]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x1C))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+4]'),def_size=0,destination=True),u'*(dw*)(raddr(ds,esp+4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+4]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+8]'),def_size=0,destination=True),u'*(dw*)(raddr(ds,esp+8))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp+8]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+8))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp]'),def_size=0,destination=False),u'*(dw*)(raddr(ds,esp))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[esp]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[g]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,offset(_data,g)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[h2]'),def_size=0,destination=False),u'*(raddr(ds,offset(_data,h2)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[i+1]'),def_size=0,destination=False),u'i+1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[i+2]'),def_size=0,destination=False),u'i+2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[i+3]'),def_size=0,destination=False),u'i+3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[i+4]'),def_size=0,destination=False),u'i+4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[i+56h]'),def_size=0,destination=False),u'i+0x56')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[i+5]'),def_size=0,destination=False),u'i+5')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[i-10h]'),def_size=0,destination=False),u'i-0x10')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[load_handle]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,offset(_data,load_handle)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[load_handle]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,load_handle)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var+3]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var)+3))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var+4]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var)+4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var-1]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var)-1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var0+5]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var0)+5))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var1+1]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var1)+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var1]'),def_size=0,destination=False),u'*(raddr(ds,offset(_data,var1)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var1]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var1)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var2+2]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var2)+2))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var2-1]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var2)-1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var2]'),def_size=0,destination=False),u'*(dw*)(raddr(ds,offset(_data,var2)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var2]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var2)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var2]'),def_size=2,destination=True),u'*(dw*)(raddr(ds,offset(_data,var2)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var3+3*4]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,var3)+3*4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var3+ebp]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,var3)+ebp))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var3]'),def_size=0,destination=False),u'*(dd*)(raddr(ds,offset(_data,var3)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var3]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,var3)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var4+t]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var4)+t))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var4]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var4)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'[var]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'_data'),def_size=1,destination=False),u'seg_offset(_data)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'a'),def_size=1,destination=True),u'm.a')
        '''
        '''
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [a]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,a)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [ebp+var_20]'),def_size=1,destination=False),u'*(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [ebp+var_20]'),def_size=1,destination=True),u'*(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [edi+1]'),def_size=0,destination=False),u'*(raddr(ds,edi+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [edi+1]'),def_size=1,destination=True),u'*(raddr(ds,edi+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [edi+7]'),def_size=0,destination=False),u'*(raddr(ds,edi+7))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [edi+7]'),def_size=1,destination=True),u'*(raddr(ds,edi+7))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [esi]'),def_size=1,destination=True),u'*(raddr(ds,esi))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [h2]'),def_size=0,destination=False),u'*(raddr(ds,offset(_data,h2)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [h]'),def_size=0,destination=False),u'*(raddr(ds,offset(_data,h)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [testOVerlap+1]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,testOVerlap)+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [var1+1]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var1)+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr [var1+2]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var1)+2))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr dl'),def_size=1,destination=True),u'dl')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr ds:[0]'),def_size=1,destination=True),u'*(raddr(ds,0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr es:[0]'),def_size=0,destination=False),u'*(raddr(es,0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'byte ptr es:[0]'),def_size=1,destination=True),u'*(raddr(es,0))')
        '''
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:0[eax*2]'),def_size=0,destination=False),u'0+eax*2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:0[ebx*4]'),def_size=0,destination=False),u'0+ebx*4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:0[ecx*8]'),def_size=0,destination=False),u'0+ecx*8')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:40h[eax*2]'),def_size=0,destination=False),u'0x40+eax*2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:40h[ebx*4]'),def_size=0,destination=False),u'0x40+ebx*4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:40h[ecx*8]'),def_size=0,destination=False),u'0x40+ecx*8')
        '''
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:[edi]'),def_size=1,destination=True),u'*(raddr(ds,edi))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ds:byte_41411F[eax]'),def_size=1,destination=True),u'*(raddr(ds,offset(_bss,byte_41411F)+eax))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [ebp+var_20+4]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+var_20+4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [ebp+var_20+4]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,ebp+var_20+4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [ebp+var_20]'),def_size=4,destination=False),u'*(dd*)(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [ebp+var_20]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [ebx-4]'),def_size=0,destination=True),u'*(dd*)(raddr(ds,ebx-4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [esp+0Ch]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x0C))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [esp+10h]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x10))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [esp+14h]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x14))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [esp+1Ch]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+0x1C))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [esp+4]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [esp+8]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp+8))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr [esp]'),def_size=4,destination=True),u'*(dd*)(raddr(ds,esp))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr buffer'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,buffer)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr es:[0]'),def_size=4,destination=True),u'*(dd*)(raddr(es,0))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr es:[20*320+160]'),def_size=4,destination=True),u'*(dd*)(raddr(es,20*320+160))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'dword ptr var4'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,var4)))')
        '''
        '''
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'large ds:4000h'),def_size=0,destination=False),u'large ds:0x4000')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset _msg'),def_size=4,destination=False),u'offset(_data,_msg)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset _test_btc'),def_size=4,destination=False),u'offset(initcall,_test_btc)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset a0x4000'),def_size=4,destination=False),u'offset(_rdata,a0x4000)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset aXorl'),def_size=4,destination=False),u'offset(_rdata,aXorl)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset aXorw'),def_size=4,destination=False),u'offset(_rdata,aXorw)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset pal_jeu'),def_size=4,destination=False),u'offset(_data,pal_jeu)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset str1'),def_size=4,destination=False),u'offset(_data,str1)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset str2'),def_size=4,destination=False),u'offset(_data,str2)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset str3'),def_size=4,destination=False),u'offset(_data,str3)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset testOVerlap'),def_size=4,destination=False),u'offset(_data,testOVerlap)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset unk_40E008'),def_size=4,destination=False),u'offset(_data,unk_40E008)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset unk_40F064'),def_size=4,destination=False),u'offset(initcall,unk_40F064)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var1'),def_size=4,destination=False),u'offset(_data,var1)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var1+1'),def_size=4,destination=False),u'offset(_data,var1)+1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var2'),def_size=4,destination=False),u'offset(_data,var2)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var3'),def_size=4,destination=False),u'offset(_data,var3)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var3+4'),def_size=4,destination=False),u'offset(_data,var3)+4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var4'),def_size=4,destination=False),u'offset(_data,var4)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var4+1'),def_size=4,destination=False),u'offset(_data,var4)+1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'offset var4+4'),def_size=4,destination=False),u'offset(_data,var4)+4')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'op0'),def_size=0,destination=False),u'op0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'op0'),def_size=4,destination=True),u'op0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'op1'),def_size=0,destination=False),u'op1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'printf'),def_size=0,destination=True),u'printf')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'ptr'),def_size=0,destination=False),u'ptr')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'r'),def_size=0,destination=False),u'r')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'res'),def_size=0,destination=False),u'res')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'res'),def_size=0,destination=True),u'res')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'res'),def_size=4,destination=False),u'res')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'res'),def_size=4,destination=True),u'res')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'resh'),def_size=0,destination=False),u'resh')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'resh'),def_size=4,destination=False),u'resh')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'resz'),def_size=0,destination=False),u'resz')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'rh'),def_size=0,destination=False),u'rh')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u's0_0'),def_size=0,destination=False),u's0_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u's0_0'),def_size=4,destination=False),u's0_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u's1_0'),def_size=0,destination=False),u's1_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u's1_0'),def_size=4,destination=False),u's1_0')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'si'),def_size=2,destination=False),u'si')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'small'),def_size=0,destination=False),u'small')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u't'),def_size=4,destination=False),u't')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'taille_moire'),def_size=4,destination=False),u'taille_moire')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'teST2'),def_size=4,destination=False),u'teST2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'testOVerlap'),def_size=0,destination=False),u'offset(_data,testOVerlap)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1'),def_size=0,destination=False),u'm.var1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1'),def_size=0,destination=False),u'offset(_data,var1)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1'),def_size=1,destination=False),u'm.var1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1'),def_size=1,destination=True),u'*(db*)&m.var1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1'),def_size=1,destination=True),u'm.var1')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1[1]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var1)+1))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1[bx+si]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var1)+bx+si))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var1[bx]'),def_size=1,destination=True),u'*(raddr(ds,offset(_data,var1)+bx))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var2'),def_size=0,destination=False),u'offset(_data,var2)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var2'),def_size=2,destination=True),u'm.var2')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var3'),def_size=4,destination=True),u'm.var3')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var3+3*4'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,var3)+3*4))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var3+ebp'),def_size=4,destination=True),u'*(dd*)(raddr(ds,offset(_data,var3)+ebp))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var5'),def_size=0,destination=False),u'offset(_data,var5)')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'word ptr [d]'),def_size=2,destination=False),u'*(dw*)(raddr(ds,offset(_data,d)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'word ptr [e]'),def_size=2,destination=False),u'*(dw*)(raddr(ds,offset(_data,e)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'word ptr [ebp+var_20]'),def_size=2,destination=False),u'*(dw*)(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'word ptr [ebp+var_20]'),def_size=2,destination=True),u'*(dw*)(raddr(ds,ebp+var_20))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'word ptr [var5+2]'),def_size=2,destination=True),u'*(dw*)(raddr(ds,offset(_data,var5)+2))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'word ptr var5'),def_size=2,destination=True),u'*(dw*)(raddr(ds,offset(_data,var5)))')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'word'),def_size=0,destination=False),u'word')
        self.assertEqual(cpp_instance.expand_new(expr=p.parse_arg(u'var3'),def_size=0,destination=False),u'm.var3')
        '''
