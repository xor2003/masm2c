...
class ParserInstructionsTest(unittest.TestCase):
    ...
    def setupClass(self):
        ...
        self.__class__.parser.symbols.set_global("_data", op.var(1, 0, issegment=True))
        self.__class__.parser.symbols.set_global("singlebyte2", op.var(size=1, offset=1, name="singlebyte2", segment="_data", elements=1))
        self.__class__.parser.symbols.set_global("word_0", op.var(size=2, offset=1, name="word_0", segment="_data", elements=1))
        self.__class__.parser.symbols.set_global("_msg", op.var(elements=2, name="_msg", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("_test_btc", op.var(name="_test_btc", offset=1, segment="initcall", size=4))
        self.__class__.parser.symbols.set_global("a", op.var(elements=3, name="a", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("a10sa08lxb08lx", op.var(elements=2, name="a10sA08lxB08lx", offset=1, segment="_rdata", size=1))
        self.__class__.parser.symbols.set_global("a10sah08lxal08l", op.var(elements=2, name="a10sAh08lxAl08l", offset=1, segment="_rdata", size=1))
        self.__class__.parser.symbols.set_global("a10sd", op.var(elements=2, name="a10sD", offset=1, segment="_rdata", size=1))
        self.__class__.parser.symbols.set_global("a10seax08lxa08l", op.var(elements=2, name="a10sEax08lxA08l", offset=1, segment="_rdata", size=1))
        self.__class__.parser.symbols.set_global("ascii", op.var(elements=2, name="ASCII", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("axorw", op.var(name="aXorw", offset=1, segment="_rdata", size=1))
        self.__class__.parser.symbols.set_global("beginningdata", op.var(name="beginningdata", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("buffer", op.var(elements=64000, name="buffer", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("byte_41411f", op.var(name="byte_41411F", offset=1, segment="_bss", size=1))
        self.__class__.parser.symbols.set_global("d", op.var(name="d", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("doublequote", op.var(elements=0, name="doublequote", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("e", op.var(name="e", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("enddata", op.var(name="enddata", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("f", op.var(name="f", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("filename", op.var(name="fileName", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("g", op.var(name="g", offset=1, segment="_data", size=4))
        self.__class__.parser.symbols.set_global("h", op.var(name="h", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("h2", op.var(name="h2", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("load_handle", op.var(name="load_handle", offset=1, segment="_data", size=4))
        self.__class__.parser.symbols.set_global("pal_jeu", op.var(elements=16, name="pal_jeu", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("str1", op.var(elements=10, name="str1", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("str2", op.var(elements=10, name="str2", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("str3", op.var(elements=10, name="str3", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("str_buffer", op.var(elements=4096, name="str_buffer", offset=1, segment="_bss", size=1))
        self.__class__.parser.symbols.set_global("wordtable", op.var(name="wordtable", elements=1, offset=1, segment="_text", size=2))
        self.__class__.parser.symbols.set_global("testoverlap", op.var(elements=14, name="testOVerlap", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("unk_40e008", op.var(name="unk_40E008", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("unk_40f064", op.var(name="unk_40F064", offset=1, segment="initcall", size=1))
        self.__class__.parser.symbols.set_global("var", op.var(elements=4, name="var", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("bytearray2", op.var(elements=10, name="bytearray2", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("wordarray", op.var(elements=3, name="wordarray", offset=1, segment="_data", size=2))
        self.__class__.parser.symbols.set_global("singlebyte", op.var(elements=1, name="singlebyte", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("bytearray", op.var(elements=100, name="bytearray", offset=1, segment="_data", size=1))
        self.__class__.parser.symbols.set_global("singlequad", op.var(elements=1, name="singlequad", offset=1, segment="_data", size=4))
...
""")
        ...
        self.__class__.parser.symbols.get_global("asgn_aptr_in_struc").implemented = True
        #?self.__class__.cpp._assignment('asgn_aptr_in_struc',self.__class__.parser.symbols.get_global('asgn_aptr_in_struc'))
        ...
        self.__class__.parser.symbols.set_global("test_bcd_ofs", op.var(elements=1, name="test_bcd_ofs", offset=1, segment="_data", size=2))
